...
export default function ErrorPageDimension() {
  const fadeInUp = {
    ...
    <div className="min-h-screen bg-black flex items-center justify-center">
      <section className="relative w-full max-w-md px-4 py-8 flex flex-col items-center justify-center">
        <motion.div className="text-center" initial="initial" animate="animate" variants={fadeInUp}>
          ...
          <h1 className="text-5xl font-bold gradient-text mb-6">Pagina Vietata Da Mobile</h1>
          <p className="text-gray-300 text-xl mb-10">Mi dispiace, per motivi grafici questa pagina non può essere usata da cellulare</p>
