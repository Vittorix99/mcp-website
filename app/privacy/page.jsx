    ...
    <div className="min-h-screen bg-black text-white py-24">
      <div className="container mx-auto px-4">
        ...
        <motion.div className="space-y-6 max-w-3xl mx-auto" initial="initial" animate="animate" variants={fadeInUp}>
          ...
          <h2 className="text-2xl font-semibold text-mcp-orange mt-8">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-mcp-orange mt-8">2. Use of Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-mcp-orange mt-8">3. Sharing of Information</h2>
          <p>
            We don't share any personally identifying information publicly or with third-parties, except when required
            to by law.
          </p>

          <h2 className="text-2xl font-semibold text-mcp-orange mt-8">4. Your Rights</h2>
          <p>
