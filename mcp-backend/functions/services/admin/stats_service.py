...
from services.events_service import get_next_event_service
...
class StatsService:
    ...
    def get_general_stats(self):
        try:
            ...
            # 📅 Evento imminente
            upcoming_event_response, status_code = get_next_event_service()
            upcoming_event_data = upcoming_event_response.get_json() if status_code == 200 else None
