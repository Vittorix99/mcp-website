...
def get_newsletter_signup_template(email, logo_url, instagram_url):
    ...
    <body style="margin: 0; padding: 0; background-color: #ffffff;">
        <table role="presentation" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; color: #1f2937; font-family: Arial, sans-serif;">
            <tr>
                <td style="padding: 40px 20px; text-align: center;">
                    <!-- Logo -->
                    <img src="{resolved_logo}" alt="MCP Logo" style="max-width: 200px; margin-bottom: 30px; " class="logo">
                    ...
                    <div style="margin: 20px 0;">
                        <a href="{resolved_instagram}" style="color: #ff4500; text-decoration: none; margin: 0 10px;">Instagram</a>
                    </div>
