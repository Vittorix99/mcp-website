  ...
  if (process.env.NEXT_PUBLIC_BRAND === "old") {
    return (
      <motion.div className="relative z-10 text-center px-4" initial="initial" animate="animate" variants={fadeInUp}>
        <h1 className="font-atlantico text-6xl md:text-8xl font-bold mb-3 gradient-text">MUSIC CONNECTING PEOPLE</h1>
        <motion.p className="font-helvetica text-xl md:text-2xl mb-8 text-gray-300" variants={fadeInUp}>
    ...
    return (
      <motion.div className="relative z-10 text-center px-4" initial="initial" animate="animate" variants={fadeInUp}>
        ...
        <motion.p className="font-helvetica text-xl md:text-2xl mt-5 mb-8 text-gray-300" variants={fadeInUp}>
          Experience the rhythm. Connect with the community.
        </motion.p>
        <motion.div variants={fadeInUp}>
          <Button
